/**
 * compat/py314.h - Python 3.14 frame structure compatibility
 *
 * Uses public Python API for portability.
 * Python 3.14 has tail-call interpreter but public API still works.
 */

#ifndef SPPROF_COMPAT_PY314_H
#define SPPROF_COMPAT_PY314_H
