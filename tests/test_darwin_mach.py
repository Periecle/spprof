...
class TestMultithreadSampling:
    ...
    @pytest.mark.skipif(not MACH_SAMPLER_AVAILABLE,
                        reason="Requires Mach-based sampler")
    def test_multithread_sampling(self, profiler):
        ...
        sample_thread_ids = set(s.thread_id for s in samples)
...
class TestArchitecture:
    ...
    def test_architecture_detection(self, profiler):
